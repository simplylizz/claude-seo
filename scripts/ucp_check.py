...
CLI
===
    uv run ucp_check.py https://store.example.com
    uv run ucp_check.py https://store.example.com --json
    uv run ucp_check.py https://store.example.com --probe-endpoints
"""
