...
CLI::
    ...
    uv run scripts/domain_history.py example.com
    uv run scripts/domain_history.py example.com --json
    uv run scripts/domain_history.py example.com --topic crypto-signals --baseline-topic veterinary
