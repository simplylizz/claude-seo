...
Usage:
    uv run dataforseo_costs.py estimate <endpoint> [--count N]
    uv run dataforseo_costs.py check <endpoint> [--count N]
    uv run dataforseo_costs.py log <endpoint> <cost> [--note TEXT]
    uv run dataforseo_costs.py summary [--days N]
    uv run dataforseo_costs.py today
    uv run dataforseo_costs.py config [--mode always|threshold|none] [--threshold AMOUNT] [--daily-limit AMOUNT]
    uv run dataforseo_costs.py reset
