...
CLI
===
    uv run iptc_ai_label.py audit ./images/
    uv run iptc_ai_label.py audit ./hero.webp
    uv run iptc_ai_label.py inject ./ai-hero.webp --source-type trainedAlgorithmicMedia
    uv run iptc_ai_label.py audit ./images/ --json
"""
