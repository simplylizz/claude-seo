...
Usage::
    ...
    uv run scripts/lcp_subparts.py https://example.com/
    uv run scripts/lcp_subparts.py https://example.com/ --form-factor PHONE --json
    ...
    if not api_key:
        return {
            "error": "Google API key not configured. "
                     "Run `uv run scripts/google_auth.py --setup`.",
        }
