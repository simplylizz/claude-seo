...
Usage::
    ...
    uv run scripts/seo_updates.py                  # latest 10
    uv run scripts/seo_updates.py --since 2025-06  # ISO yyyy or yyyy-mm filter
    uv run scripts/seo_updates.py --kind core
    uv run scripts/seo_updates.py --json
    uv run scripts/seo_updates.py --unverified     # show 3rd-party claims awaiting check
"""
