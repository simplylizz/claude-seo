...
Usage::
    ...
    uv run scripts/unlighthouse_run.py https://example.com
    uv run scripts/unlighthouse_run.py https://example.com --json
    uv run scripts/unlighthouse_run.py https://example.com --device desktop --max-routes 50
"""
