...
CLI
===
    uv run render_page.py https://nuxt.com --mode always
    uv run render_page.py https://example.com --mode auto --json
    uv run render_page.py https://store.example.com --block image --block font
"""
    ...
    if not should_render:
        ...
        if sync_playwright is None:
            result["error"] = (
                ...
                "Run with uv (auto-installs deps): uv run render_page.py "
