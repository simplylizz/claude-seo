...
Usage::
    ...
    cat product.json | uv run scripts/schema_ecommerce_validate.py
    uv run scripts/schema_ecommerce_validate.py product.json --eu
    uv run scripts/schema_ecommerce_validate.py product.json --json
