...
Usage::
    ...
    uv run scripts/gbp_deprecation_lint.py https://example.com
    uv run scripts/gbp_deprecation_lint.py page.html --file
    uv run scripts/gbp_deprecation_lint.py https://example.com --json
