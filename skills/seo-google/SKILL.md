...
```bash
uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/google_auth.py" --check --json
```
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/pagespeed_check.py" <url> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/pagespeed_check.py" <url> --crux-only --json`

### `/seo google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/crux_history.py" <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/gsc_query.py" --property <property> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/gsc_inspect.py" <url> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/gsc_inspect.py" --batch <file> --json`

### `/seo google sitemaps <property>`

List submitted sitemaps with status, errors, warnings.

**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/gsc_query.py" sitemaps --property <property> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/indexing_notify.py" <url> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/indexing_notify.py" --batch <file> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/ga4_report.py" --property <id> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/ga4_report.py" --property <id> --report top-pages --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/youtube_search.py" search "<query>" --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/youtube_search.py" video <video_id> --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/nlp_analyze.py" --url <url> --json` or `--text "..."`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/nlp_analyze.py" --url <url> --features entities --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/keyword_planner.py" ideas "<seed>" --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/keyword_planner.py" volume "<kw1>,<kw2>" --json`
...
**Script:** `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/google_report.py" --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/pagespeed_check.py" <url> --json > data.json`
3. Generate report: `uv run "${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/seo}/scripts/google_report.py" --type cwv-audit --data data.json --domain <domain>`
